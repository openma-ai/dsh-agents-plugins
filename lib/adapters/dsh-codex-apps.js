...
function bundledMcpServerNames(input) {
    const names = new Set();
...
function appMaterialization(input) {
...
export const dshCodexAppsAdapter = {
    name: 'dsh-codex-apps',
    componentTypes: ['app'],
...
//# sourceMappingURL=dsh-codex-apps.js.map