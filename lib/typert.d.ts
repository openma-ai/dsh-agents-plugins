...
export declare const TYPERT: {
    ...
    model: {
        services: {
            ...
            members: {
                kind: string;
                name: "snapshot" | "discoverLocal" | "discoverMarketplaces" | "addMarketplace" | "importMarketplace" | "importLocal" | "installPlugin" | "setEnabled" | "piUpdates" | "checkPiUpdates" | "setPiUpdateMode" | "setPiPackageAutoUpdate" | "updatePiPackage" | "updateAllPiPackages";
                signature: "snapshot(): AgentPluginsSnapshot" | "discoverLocal(): Promise<AgentPluginsLocalDiscoveryView>" | "discoverMarketplaces(): Promise<AgentPluginsMarketplaceDiscoveryView>" | "addMarketplace(location: string): Promise<AgentPluginsSnapshot>" | "importMarketplace(ref: string): Promise<AgentPluginsSnapshot>" | "importLocal(ref: string): Promise<AgentPluginsSnapshot>" | "installPlugin(name: string, marketplace: string): Promise<AgentPluginsInstallResult>" | "setEnabled(name: string, enabled: boolean): Promise<AgentPluginsSnapshot>" | "piUpdates(): AgentPluginsPiUpdateStatus" | "checkPiUpdates(): Promise<AgentPluginsPiUpdateStatus>" | "setPiUpdateMode(mode: AgentPluginsPiUpdateMode): Promise<AgentPluginsPiUpdateStatus>" | "setPiPackageAutoUpdate(id: string, enabled: boolean): Promise<AgentPluginsPiUpdateStatus>" | "updatePiPackage(id: string): Promise<AgentPluginsPiUpdateStatus>" | "updateAllPiPackages(): Promise<AgentPluginsPiUpdateStatus>";
                summary: string;
                jsDoc: string;
            }[];
            types: never[];
