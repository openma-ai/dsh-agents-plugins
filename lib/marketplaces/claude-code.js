import { parseGitRepositorySource, parseGitHubRepositorySource, parseMarketplaceRelativeDirectory, parsePluginEntry, requireIdentifier, requirePlugins, requireRecord, requireUniquePluginNames, } from './validation.js';
...
function parseClaudeCodeSource(value, field) {
    ...
    if (source.commit === undefined)
        return parseGitHubRepositorySource(source, field);
